-- Final corrected version of get_user_conversations (v3)
-- This version corrects the data type for the other_username column to match the users table schema.
...
DO $$
BEGIN
    RAISE NOTICE 'Function get_user_conversations(UUID) has been corrected and updated successfully (v3).';
END $$;
