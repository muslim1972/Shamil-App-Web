-- Final corrected version of get_user_conversations (v2)
-- This version uses the public.users table which contains the username column.
...
BEGIN
    ...
    FROM
        ...
        -- Get the other user's data from the public.users table
...
DO $$
BEGIN
    RAISE NOTICE 'Function get_user_conversations(UUID) has been corrected and updated successfully (v2).';
END $$;
