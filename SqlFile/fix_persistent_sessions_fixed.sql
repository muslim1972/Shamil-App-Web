...
-- 1. إنشاء دالة محسّنة للتحقق من وجود المستخدم مع معالجة الأخطاء
...
-- 2. إنشاء دالة بسيطة للتحقق من وجود المستخدم فقط
...
-- 3. إصلاح جدول users لضمان توافق الجلسات
ALTER TABLE users 
...
-- 5. تحديث بيانات المستخدمين الحاليين
UPDATE users 
SET last_login = NOW(),
...
-- 6. مزامنة بيانات المستخدمين من auth.users
