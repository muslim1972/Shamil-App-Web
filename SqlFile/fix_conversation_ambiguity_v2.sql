...
-- إصلاح مشكلة الغموض في مرجع conversation_id في دالة create_or_get_conversation_with_user (إصلاح شامل)
...
BEGIN
    ...
    -- إرجاع معرف المحادثة
    RETURN QUERY SELECT v_conversation_id AS conversation_id;
END;
$$;
